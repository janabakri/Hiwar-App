...
class TestChatModels:
    ...
    async def test_chat_response_creation(self):
    ...
    async def test_chat_response_optional_fields(self):
...
class TestChatEndpoint:
    ...
    def test_chat_creates_new_user(self, test_db):
        ...
        assert user.name == "new_user_123"  # auto-provisioned name mirrors the user_id
        assert user.level == "pending"

    def test_chat_uses_existing_user(self, test_db):
    ...
    def test_chat_detects_and_saves_errors(self, test_db):
    ...
    def test_chat_increments_error_count_on_repeat(self, test_db):
    ...
    def test_chat_handles_no_errors(self, test_db):
    ...
    def test_chat_response_contains_reply(self, test_db):
    ...
    def test_chat_multiple_errors_in_one_message(self, test_db):
    ...
    def test_chat_saves_context(self, test_db):
    ...
    def test_chat_error_timestamps(self, test_db):
...
class TestChatFallback:
    ...
    def test_chat_falls_back_when_openai_key_missing(self, test_db, monkeypatch):
    ...
    def test_chat_returns_corrections_even_without_openai(self, test_db, monkeypatch):
...
class TestUserModel:
    ...
    async def test_user_statistics_defaults(self, test_db):
...
class TestErrorModel:
    ...
    async def test_error_creation(self, test_db):
    ...
    async def test_error_count_increment(self, test_db):
    ...
    async def test_error_mastered_flag(self, test_db):
